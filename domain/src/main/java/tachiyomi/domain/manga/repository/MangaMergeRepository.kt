...
interface MangaMergeRepository {
    ...
    fun subscribeMergedManga(): Flow<List<Manga>>
    ...
    fun subscribeReferencesById(id: Long): Flow<List<MergedMangaReference>>
    ...
    fun subscribeMergeMangaForDownloading(mergeId: Long): Flow<List<Manga>>

    fun subscribeAllMergeMangaForDownloading(): Flow<List<Manga>>
}
