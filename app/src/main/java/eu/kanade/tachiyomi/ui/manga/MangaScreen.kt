...
class MangaScreen(
    ...
    override fun onProvideAssistUrl(): String? {
        return (screenModel?.state?.value as? MangaScreenModel.State.Success)?.assistUrl
    }
    ...
    override fun Content() {
        ...
        LaunchedEffect(successState.manga, screenModel.source) {
            if (isHttpSource) {
                screenModel.fetchAssistUrl(screenModel.manga, screenModel.source)
            }
        }
        ...
        MangaScreen(
            ...
            onTagSearch = { screenModel.launchSearch { performGenreSearch(navigator, it, screenModel.source!!) } },
            onFilterButtonClicked = screenModel::showSettingsDialog,
            onRefresh = screenModel::fetchAllFromSource,
            onContinueReading = { continueReading(context, screenModel.getNextUnreadChapter()) },
            onSearch = { query, global -> screenModel.launchSearch { performSearch(navigator, query, global) } },
