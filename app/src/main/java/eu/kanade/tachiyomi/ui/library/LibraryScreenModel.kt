...
class LibraryScreenModel(
    ...
    init {
        screenModelScope.launchIO {
            ...
            ) { (searchQuery, categories, favorites), (tracksMap, trackingFilters), (categoryFilters, filteredCategories), itemPreferences ->
    ...
    fun openDeleteMangaDialog() {
        mutableState.update { it.copy(dialog = LibraryScreenModel.Dialog.DeleteManga(state.value.selectedManga)) }
    }
    ...
    data class State(
        ...
        val libraryData: LibraryScreenModel.LibraryData = LibraryData(),
